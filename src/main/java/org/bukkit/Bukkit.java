...
public final class Bukkit {
    ...
    /**
     * Gets the current server singleton wrapped in {@link org.bukkit.craftbukkit.CraftServer}
     * 
     * For {@link net.glowstone.GlowServer} (non-linkstone modified getServer) use {@link #getNonLinkstone()}
     * 
     * @see {@link #getNonLinkstone()}
     */
     ...
     */
    public static Server getNonLinkstone() {
        return nonlinkstone;
    }
    ...
    public static void setServer(Server server) {
        ...
        server.getLogger().info("Running " + server.getName() + " version " + server.getVersion() + " (Implementing API version " + server.getBukkitVersion() + ")");
        server.getLogger().info("Running " + getName() + " version " + getVersion() + " (Implementing API version " + getBukkitVersion() + ")");
    }
    ...
    public static PlayerProfile createProfile(UUID arg0) {
        return server.createProfile(arg0);
    }

    public static PlayerProfile createProfile(String arg0) {
        return server.createProfile(arg0);
    }

    public static PlayerProfile createProfile(UUID arg0, String arg1) {
        return server.createProfile(arg0, arg1);
    }
}